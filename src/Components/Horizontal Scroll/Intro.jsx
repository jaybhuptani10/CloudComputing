...
const Intro = () => {
  return (
    <div className="relative h-full w-full flex items-center z-40  ml-5">
      <div className="w-1/2 flex flex-col gap-4   rounded-xl p-2 backdrop-blur-xl overflow-hidden z-40">
        <h1 className="text-xl text-[#fff] text-left px-2 leading-6  z-40">
